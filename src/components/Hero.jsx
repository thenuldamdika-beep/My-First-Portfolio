            ...
            <div className="container hero-content">
                <div className="hero-text reveal-up active">
                    ...
                    <div className="social-links">
                        ...
                        <a href="https://github.com/thenuldamdika-beep" target="_blank" rel="noreferrer" aria-label="GitHub">
                ...
                <div className="hero-image-wrapper reveal-left active" style={{ height: "auto", padding: "2rem 0" }}>
                    <div className="image-box" style={{ width: "280px", height: "280px", borderRadius: "50%", boxShadow: "var(--shadow-xl)", border: "8px solid white", margin: "0 auto" }}>
                        <img src={`${import.meta.env.BASE_URL}profile.png`} alt="Thenul Damdika" className="profile-img" style={{ width: "100%", height: "100%", objectFit: "cover", borderRadius: "50%", zIndex: 2, position: "relative" }} />
                    </div>
                </div>
            </div>
        </section>
